  ...
  return (
    <main>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10 space-y-8">
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">How to Submit a Complaint</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">Complaint Channels</h2>
          <ul className="text-gray-600 space-y-2 list-disc list-inside">
            <li>Download and complete the Consumer Complaint Form and submit it to our offices.</li>
            <li>Email your complaint to <a href="mailto:kelious.mlenga@macra.mw" className="text-[#E30613] underline">kelious.mlenga@macra.mw</a></li>
            <li>Call us on <a href="tel:011810497" className="text-[#E30613] underline">(+265) (0) 1 810 497</a></li>
            <li>Visit us in person at Snr Chief Kapeni Campus, 8 Kasungu Crescent, Private Bag 261, Chichiri, Blantyre.</li>
          </ul>
        </div>
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">What to Include</h2>
