...
export default function ConsumerAffairsPage() {
  return (
    <main>
      ...
      <JsonLd data={webPageSchema("Consumer Affairs", "MACRA consumer affairs programmes protect the interests of communications consumers throughout Malawi.", "/consumer-protection/consumer-affairs")} />
      ...
      <section className="max-w-7xl mx-auto px-4 py-10 space-y-8">
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">Our Mandate</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">What We Do</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">Legal Framework</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-[#E30613] mb-3">Contact the Consumer Affairs Unit</h2>
          <p className="text-gray-600">For enquiries or to report a concern contact us on <a href="tel:011810497" className="text-[#E30613] underline">(+265) (0) 1 810 497</a> or email <a href="mailto:kelious.mlenga@macra.mw" className="text-[#E30613] underline">kelious.mlenga@macra.mw</a>.</p>
        </div>
      </section>
    </main>
  );
