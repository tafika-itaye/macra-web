    ...
    <main>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div>
            <h2 className="text-xl font-bold text-[#E30613] mb-4">Our Community Commitment</h2>
            ...
            <h3 className="text-base font-semibold text-[#E30613] mt-4 mb-3">Programme Areas</h3>
