...
export default function RulesRegulationsPage() {
  return (
    <main>
      ...
      <JsonLd data={webPageSchema("Rules and Regulations", "MACRA rules and subsidiary regulatory instruments made under the Communications Act.", "/media/rules-regulations")} />
