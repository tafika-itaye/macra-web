...
export default function MacraMagazinePage() {
  return (
    <main>
      ...
      <JsonLd data={webPageSchema("MACRA Magazine", "MACRA magazine editions featuring regulatory updates, sector news, and stakeholder stories.", "/media/macra-magazine")} />
