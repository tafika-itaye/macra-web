...
export default function FaultHandlingPage() {
  return (
    <main>
      ...
      <JsonLd data={webPageSchema("Fault Handling", "MACRA telecommunications fault handling procedures, escalation timelines, and consumer remedies.", "/services/telecommunications/fault-handling")} />
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="text-xl font-bold text-[#E30613] mb-4">Fault Handling Regulations</h2>
        ...
        <h3 className="text-base font-semibold text-[#E30613] mb-3">Operator Requirements</h3>
