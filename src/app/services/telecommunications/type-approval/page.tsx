  ...
  return (
    <main>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="text-xl font-bold text-[#003087] mb-4">Type Approval</h2>
        ...
        <h3 className="text-base font-semibold text-[#003087] mb-3">Equipment Requiring Type Approval</h3>
        ...
        <h3 className="text-base font-semibold text-[#003087] mb-3">Application Process</h3>
        ...
        <p className="text-sm text-gray-500">For application forms visit the <a href="/media/application-forms" className="text-[#003087] underline hover:text-[#C8A84B]">Application Forms</a> page or contact MACRA at <a href="mailto:dg@macra.mw" className="text-[#003087] underline hover:text-[#C8A84B]">dg@macra.mw</a>.</p>
      </section>
    </main>
  );
}
