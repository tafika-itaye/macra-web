  ...
  return (
    <main>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="text-xl font-bold text-[#003087] mb-4">Postal Quality of Service</h2>
        ...
        <h3 className="text-base font-semibold text-[#003087] mb-3">Key Standards</h3>
        ...
        <p className="text-sm text-gray-500">Annual postal QoS monitoring reports are available on the <a href="/media/qos-reports" className="text-[#003087] underline hover:text-[#C8A84B]">QoS Reports</a> page.</p>
      </section>
    </main>
  );
}
