  ...
  return (
    <main>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="text-xl font-bold text-[#E30613] mb-4">National Addressing Project</h2>
        ...
        <h3 className="text-base font-semibold text-[#E30613] mb-3">Project Objectives</h3>
